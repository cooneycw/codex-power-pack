...
description: "List and search GitHub issues in the current or specified repository"
---
...
List and search issues in the current or explicitly specified GitHub repository.
