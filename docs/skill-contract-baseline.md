...
| Extracted packaged-Markdown references | 747 |
...
|---|---:|---|
| Resolvable | 446 | Explicit `$skill-name` resolves to a packaged skill. |
| Native | 29 | Supported Codex host command. |
| Adapted | 179 | The packaged skill carries an explicit Codex harness adaptation. |
| Excluded | 26 | Target has a reviewed, owned, time-bound exclusion. |
