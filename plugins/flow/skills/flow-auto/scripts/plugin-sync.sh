...
declare -A EXTRA_FILES=(
    ...
    [flow]="<SKILL_DIR>/scripts/flow-start-resolve.sh <SKILL_DIR>/scripts/flow-live-driver-guard.sh scripts/flow-worktree-claim.sh <SKILL_DIR>/scripts/flow-finish-gate.sh <SKILL_DIR>/scripts/flow-stale-check.sh <SKILL_DIR>/scripts/flow-worktree-guard.sh <SKILL_DIR>/scripts/gh-pr-merge.sh <SKILL_DIR>/scripts/worktree-remove.sh <SKILL_DIR>/scripts/friction-log.sh <SKILL_DIR>/scripts/check-ignored-additions.sh scripts/flow-helpers-install.sh"
